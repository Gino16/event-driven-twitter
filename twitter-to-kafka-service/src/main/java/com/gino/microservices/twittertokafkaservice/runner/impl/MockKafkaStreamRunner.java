...
import com.gino.microservices.twittertokafkaservice.exception.TwitterToKafkaServiceException;
...
public class MockKafkaStreamRunner implements StreamRunner {
        ...
        Executors.newSingleThreadExecutor().submit(() -> {
            try {
                while (true) {
                    ...
                    log.info("formattedTweetAsRawJson {}", formattedTweetAsRawJson);
    ...
    private void sleep(long sleepTimeMs) {
        try {
            ...
            throw new TwitterToKafkaServiceException("Error while sleeping for waiting new status to cread!!");
        }
    }
